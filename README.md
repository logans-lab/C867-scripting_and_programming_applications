...
Built in C++ using Xcode. Completed in July 2020.

Given the scenario and specifications below, create a working application to filter and sort student data:
...
•  email address
•  age
•  array of number of days to complete each course degree program
